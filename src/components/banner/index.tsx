...
const Banner = ({ bg, source }: bannerProp) => {
  return (
    <Main bg={bg} source={source}>
      ihsad sdasd sadsasad how i can make background image in each div
      @osvaldoalvaradodev osvaldoalvaradodev commented on Aug 11, 2018 How i
      made this with CSS style in react ? :s @Sergioamjr Sergioamjr commented on
      Nov 26, 2018 • You can do with dinamic props, like that const Content =
